...
\caption{\footnotesize We demonstrate the formatting of a
  ...
  details, see the \href{http://www.bibtex.org/Format/}{BibTex file format specification}.}
\end{figure}

\paragraph{Typesetting with BibTeX Reference}
This can be annoying at first! In order to get
references correct, we
must take a couple passes through the document. 
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.5]{fig/citations.png}
\caption{\footnotesize
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.4]{fig/demo-pdf.png}
\caption{\footnotesize
